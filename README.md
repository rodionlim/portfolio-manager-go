...
[![CI](https://github.com/rodionlim/portfolio-manager-go/actions/workflows/ci.yml/badge.svg)](https://github.com/rodionlim/portfolio-manager-go/actions/workflows/ci.yml) [![Version](https://img.shields.io/badge/version-1.44.0-blue.svg)](https://github.com/rodionlim/portfolio-manager-go/blob/main/VERSION)
...
# Get historical price data for a futures contract (Barcharts)
curl -X GET "http://localhost:8080/api/v1/mdata/price/historical/HEJ26?start=20240101&end=20251231"
```
