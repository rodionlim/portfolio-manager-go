    ...
    "paths": {
        ...
        "/api/v1/mdata/dividends/{ticker}": {
            ...
            "delete": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Dividend type (Custom or Official)",
                        "name": "type",
                        "in": "query",
                        "required": true
                    }
                ...
                "responses": {
                    "200": {
                        "description": "Dividends metadata deleted successfully",
                        "schema": {
                            "$ref": "#/definitions/common.SuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad request - Ticker is required or invalid type",
                        "schema": {
                            "type": "string"
                        }
                    },
        ...
        "/api/v1/options/price": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Option pricing request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/optionpricer.PriceRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "Option valuation and Greeks",
                        "schema": {
                            "$ref": "#/definitions/optionpricer.PriceResponse"
                        }
                    },
                    "400": {
                        "description": "Invalid request",
                    ...
                    "500": {
                        "description": "Failed to price option",
                        "schema": {
                            "$ref": "#/definitions/common.ErrorResponse"
                        }
                    }
