...
This project contains the web interface for the Portfolio Manager application. It includes a React application built with Mantine UI and a Go server to serve the built application.
