...
const BlotterTable: React.FC = () => {
  ...
  const columns = useMemo<MRT_ColumnDef<Trade>[]>(
    () => [
      ...
      { accessorKey: "UnderlyingTicker", header: "Underlying" },
      { accessorKey: "ExpiryDate", header: "Expiry" },
      { accessorKey: "StrikePrice", header: "Strike" },
      { accessorKey: "CallPut", header: "CP" },
      {
        id: "ccy",
        header: "CCY",
      ...
      if (selection.length > 0) {
        ...
        navigate("/blotter/add_trade", {
          state: {
            ...
            instrumentType: ticker.original.InstrumentType,
            underlyingTicker: ticker.original.UnderlyingTicker,
            underlyingSpotRef: ticker.original.UnderlyingSpotRef,
            expiryDate: ticker.original.ExpiryDate,
            strikePrice: ticker.original.StrikePrice,
            callPut: ticker.original.CallPut,
      ...
      if (selectedRows.length === 1) {
        ...
        navigate("/blotter/update_trade", {
          state: {
            ...
            underlyingTicker: selection.UnderlyingTicker,
            underlyingSpotRef: selection.UnderlyingSpotRef,
            expiryDate: selection.ExpiryDate,
            strikePrice: selection.StrikePrice,
            callPut: selection.CallPut,
            book: selection.Book,
            broker: selection.Broker,
            account: selection.Account,
            status: selection.Status,
            origTradeID: selection.OrigTradeID,
